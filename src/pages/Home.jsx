    ...
    <>
          ...
          >
            ...
            >
              <div className="flex flex-col justify-between items-left w-full mm:w-1/2">
                ...
                <div className="my-4">
                  <p className="mb-4">
                    Hi we are York University’s Esports club, we host{" "}
                    <a href="/events">community events</a> and are home to York
                    University’s <a href="/teams">esports teams</a> as well!
                  </p>
                  <p>
                    This club is open to students of all interest levels in
                    gaming and we strive to create a comfortable space for.
                  </p>
                </div>
              </div>
              <Button
      ...
      <div className={`bg-primary ${styles.flexStart} overflow-hidden`}>
        <div className={`${styles.boxWidth} mx-8 xs:mx-20 ss:mx-24`}>
          ...
          <section
            id="home"
            className={`flex mm:flex-row flex-col ${styles.paddingY} px-0`}
          >
              ...
              <div className="grid grid-cols-1 xm:grid-cols-2 justify-between gap-y-10 gap-x-10 items-left w-full me:w-2/3 my-4">
                {eventsList.map((events, index) => (
                  <TinyEvent
                    ...
                    className={`${index > 1 ? "hidden xm:block" : "xm:block"}`}
                  />
                ))}
              </div>
              <Button
                ...
                <div className="flex flex-col justify-between items-left w-full">
                  ...
                  <div className="my-4 grid grid-cols-1">
                    {recent.map((rec, index) => (
                      <div
                        className={`w-full grid grid-cols-2 xs:grid-cols-3 xm:grid-cols-4 mm:grid-cols-9 items-center justify-self-center ${
                      ...
                      >
                        ...
                        <h4
                          className={`${styles.titleH4} col-span-1 mm:col-span-2 justify-self-center mm:flex hidden`}
                        >
                          {rec.time}
                        </h4>
                        <img
                          ...
                          alt=""
                          className={`${
                            index % 2 === 0 ? "hidden" : "mm:flex hidden p-5"
                          } justify-self-center`}
                        />
                        <img
                          src={rec.opp}
                          alt=""
                          className={`${
                            index % 2 === 1 ? "hidden" : "mm:flex hidden p-5"
                          } justify-self-center`}
                        />
                        <p
                          className={`${styles.titleH4} text-[50px] mm:p-5 p-0 justify-self-center `}
                        >
                          {" "}
                          {rec.score}{" "}
                        </p>
                        ...
                        />
                        <p className="location mm:col-span-2 col-span-1 justify-self-center xs:flex hidden">
                          {" "}
                          {rec.title}
                        </p>
                        <div className="description justify-self-center xm:grid grid-rows-2 text-end hidden justify-items-end">
                          <p
                            className={`${
                              rec.twitch != null ? "hidden" : "mm:flex hidden"
                            }`}
                          >
                            Twitch VOD&nbsp;
                ...
                <div className="flex flex-col justify-between items-left w-full">
                  ...
                  <div className="my-4 grid grid-cols-1">
                    {upcoming.map((up, index) => (
                      <div
                        className={`w-full grid grid-cols-2 xs:grid-cols-3 xm:grid-cols-5 mm:grid-cols-9 items-center justify-self-center ${
                          index === recent.length - 1 ? "" : "borderb"
                        }`}
                      >
                        ...
                        <h4
                          className={`${styles.titleH4} xm:col-span-2 justify-self-center xm:flex hidden`}
                        >
                          {up.time}
                        </h4>
                        <img
                        ...
                        />
                        <p
                          className={`${styles.titleH4} text-[50px] mm:p-5 p-0 justify-self-center mm:flex hidden `}
                        >
                          {" "}
                          vs.{" "}
                        </p>
                        ...
                        />
                        <p className="location mm:col-span-3 col-span-1 xs:col-span-2 justify-self-center">
                          {" "}
                          {up.title}
                        </p>
                      </div>
